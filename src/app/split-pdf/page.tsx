  ...
  return (
    <div className="min-h-screen py-8 md:py-12">
      <div className="mx-auto max-w-6xl px-4">
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3">Split PDF</h1>
        <p className="text-slate-600 mb-8">Extract specific pages or split PDF into multiple files.</p>
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          {file && (
            <div className="mt-6">
              ...
              <button className="mt-4 inline-flex items-center justify-center rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-700">Split PDF</button>
            </div>
          )}
        </div>
      </div>

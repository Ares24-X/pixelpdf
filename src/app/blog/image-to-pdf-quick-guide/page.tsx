...
export const metadata: Metadata = {
  title: 'How to Convert Image to PDF Online Free (2026)',
  description: 'Quick guide on converting JPG, PNG, and other images to PDF online. No registration, no upload to servers, 100% free.',
  keywords: ['image to PDF', 'JPG to PDF', 'PNG to PDF', 'convert image to PDF', 'picture to PDF'],
  openGraph: {
    title: 'How to Convert Image to PDF Online Free (2026)',
    description: 'Quick guide on converting images to PDF. Free, fast, and secure.',
    type: 'article',
  },
};
